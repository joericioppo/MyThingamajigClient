//
//  NSObject+FOOCoding.m
//  Thingamajigs
//
//  Created by Joe Ricioppo on 2/20/12.
//  I copied this code from Mike Lee and didn't actually get his permission to post this but I use it all the time so I hope he laughs when he reads this.
//
